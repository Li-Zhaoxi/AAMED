...
methods_names = [{'Liu'},{'CRHT'},{'Prasad'}, {'ELSD'}, {'YAED'}, {'Wang'}, {'RCNN'},{'TPED'}, {'gmmed'}, {'CNED'}, {'Wu'}, {'Lu'}, {'FLED'}];
method_labels = [{'liu'},{'crht'},{'prasad'}, {'elsd'}, {'yaed'}, {'wang'}, {'rcnn'},{'tped'}, {'gmmed2'}, {'cned'}, {'wu'}, {'lu'}, {'fled'}];
